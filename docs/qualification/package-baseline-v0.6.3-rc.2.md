...
> Superseded: `v0.6.3-rc.2` was package/archive-verified for numeric manifest version fields but was not Chrome-loadable because the manifest referenced `icon-16.png` and the ZIP/XPI did not include that file. Use `v0.6.3-rc.3` or later.
